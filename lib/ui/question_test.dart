...
class QuestionTextState extends State<QuestionTest> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _fontSizeAnimation.addListener(() => this.setState(() {})); // Rebuild our text
    _fontSizeAnimationController.forward(); // Start our animation
  }
